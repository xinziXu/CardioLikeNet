 function [ecg_data,ANNOT,ATRTIME,RRtime]=read_data_5classes(filenum,PATH)
% -------------------------------------------------------------------------
%version1.0 created by Y. Zhao 07/21/2018
%------ SPECIFY DATA ------------------------------------------------------
%------ -------------------------------------------------------
%PATH= '/Users/xuxinzi/Documents/research/ECG/project/MITBIHdata'; % path
